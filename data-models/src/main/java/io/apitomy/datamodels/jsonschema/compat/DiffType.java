...
public enum DiffType {
    ...
    ARRAY_TYPE_ITEM_SCHEMA_REMOVED(false),
    ARRAY_TYPE_ITEM_SCHEMAS_CHANGED(false),
    ARRAY_TYPE_ITEM_SCHEMAS_EXTENDED(true),
    ARRAY_TYPE_ITEM_SCHEMAS_LENGTH_DECREASED(false),
    ARRAY_TYPE_ITEM_SCHEMAS_LENGTH_INCREASED(false),
    ...
    COMBINED_TYPE_ANY_OF_SIZE_INCREASED(true),
    ...
    COMBINED_TYPE_ONE_OF_SIZE_INCREASED(true),
    ...
    CONST_TYPE_VALUE_ADDED(false),
    CONST_TYPE_VALUE_CHANGED(false),
    CONST_TYPE_VALUE_REMOVED(true),

    ENUM_TYPE_VALUES_ADDED(false),
    ...
    OBJECT_TYPE_PROPERTY_NAMES_SCHEMA_ADDED(false),
    OBJECT_TYPE_PROPERTY_NAMES_SCHEMA_REMOVED(true),
    OBJECT_TYPE_PROPERTY_NAMES_SCHEMA_COMPATIBLE_BOTH(true),
    OBJECT_TYPE_PROPERTY_NAMES_SCHEMA_COMPATIBLE_BACKWARD_NOT_FORWARD(true),
    OBJECT_TYPE_PROPERTY_NAMES_SCHEMA_COMPATIBLE_FORWARD_NOT_BACKWARD(false),
    OBJECT_TYPE_PROPERTY_NAMES_SCHEMA_COMPATIBLE_NONE(false),
    ...
    REFERENCE_TYPE_TARGET_SCHEMA_REMOVED(false),
