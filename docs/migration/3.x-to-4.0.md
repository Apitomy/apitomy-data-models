...
| 3.x | 4.0 |
|---|---|
| `BooleanJSchemaJSchemaListUnion` | `…models.jsonschema.BooleanFullSchemaFullSchemaListUnion` |
| `JSchemaListUnionValue`, `…Impl` | `…models.jsonschema.FullSchemaListUnionValue`, `…Impl` |
