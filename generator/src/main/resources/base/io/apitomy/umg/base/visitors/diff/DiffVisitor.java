...
/**
 * Visitor for paired tree traversal. The generated DiffTraverser walks two trees
 * in parallel, calling these methods for each field. Subclasses override the methods
 * they care about.
 *
...
public abstract class DiffVisitor {
    ...
    /**
     * Called for each list-typed field with the pairing result.
     * The traverser auto-recurses into matched entity/union pairs after this call.
     */
    public void diffList(String propertyName, CollectionDiff<Integer, ?> diff) {
    }

    /**
     * Called for each map-typed field with the pairing result.
     * The traverser auto-recurses into matched entity/union pairs after this call.
     */
